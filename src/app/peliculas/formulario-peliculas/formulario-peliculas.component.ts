...
export class FormularioPeliculasComponent implements OnInit {
  ...
  form = this.formBuilder.group({
    titulo: ['', {validartor: [Validators.required]}],
    fechaLanzaiento: new FormControl<Date | null> (null, {validators: [Validators.required]}),
    trailer: '' ,
    ...
    obtenerErrorCampoFechaLanzamiento(): string {
      let campo = this.form.controls.fechaLanzaiento;
